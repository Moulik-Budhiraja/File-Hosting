...
/** Legacy synthetic client input. It is intentionally untrusted and ignored
 * unless the separately configured ingress proof is present. */
 ...
 * cross-tab propagation. The synthetic address remains untrusted input. */
...
// task-restoration specs: one needle key created first, then 12 owners × 9
// newer keys so newest-first pagination buries the needle beyond page one.
...
export async function uploadFile(
  ...
  content: string | Buffer = "synthetic-bytes",
