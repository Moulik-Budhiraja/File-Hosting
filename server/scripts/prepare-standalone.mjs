...
const copies = [
  ...
  {
    from: path.join(serverRoot, "public-url.js"),
    to: path.join(standalone, "public-url.js"),
  },
  {
    from: path.join(serverRoot, "standalone-start.js"),
    to: path.join(standalone, "start.js"),
  },
];
