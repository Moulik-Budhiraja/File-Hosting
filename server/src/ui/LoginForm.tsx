...
export function LoginForm({
  ...
  async function submit(event: React.FormEvent) {
    ...
    if (state.kind === "submitting" || state.kind === "throttled") return;
  ...
  return (
    <form className="login-form" onSubmit={submit} noValidate>
      ...
      <div className="field">
        ...
        <input
          ...
          onChange={(event) => {
            ...
            if (throttled) setState({ kind: "idle" });
          }}
        />
      </div>
      <div className="field">
      ...
      <div aria-live="polite">
        ...
        {throttled ? (
          <div className="notice notice-warning">
            ...
            <p>
              Sign-in is temporarily locked for this address. Try again in a few
              minutes.
            </p>
          </div>
        ) : null}
      ...
      <button
        ...
        disabled={state.kind === "submitting" || throttled}
      >
        {throttled
          ? "Sign in — locked"
